...
def test_search_cache_set_get_delete(monkeypatch):
    """Test case for test search cache set get delete."""
    fake = FakeRedis()
...
def test_search_cache_invalid_json(monkeypatch):
    """Test case for test search cache invalid json."""
    fake = FakeRedis()
...
def test_invalidate_stats_cache(monkeypatch):
    """Test case for test invalidate stats cache."""
    fake = FakeRedis()
...
def test_typesense_client_disabled(monkeypatch):
    """Test case for test typesense client disabled."""
...
def test_typesense_search(monkeypatch):
    ...
    """Test case for test typesense search."""
