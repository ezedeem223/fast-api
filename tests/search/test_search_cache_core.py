"""Test module for test search cache."""
import fnmatch
...
def test_popular_searches_uses_cache(session, test_user, fake_redis):
    """Test case for test popular searches uses cache."""
...
def test_user_searches_invalidation(session, test_user, fake_redis):
    """Test case for test user searches invalidation."""
