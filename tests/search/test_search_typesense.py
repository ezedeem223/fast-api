"""Test module for test search typesense."""
import os
...
class FakeTypesenseClient:
    """Test class for FakeTypesenseClient."""
...
def disable_redis(monkeypatch):
    """Pytest fixture for disable_redis."""
...
def test_search_uses_typesense_results(monkeypatch, authorized_client, sample_posts):
    """Test case for test search uses typesense results."""
    hits = [
...
def test_search_falls_back_when_typesense_errors(
    ...
    """Test case for test search falls back when typesense errors."""
