"""Test module for test living memory."""
...
def test_living_memory_logic(db_session, test_user):
    ...
    # Arrange: create two semantically similar posts for the same user.
    post1 = Post(
    ...
    # Act: process the new post to create a memory relation.
    ...
    # Assert: relation exists with expected metadata.
