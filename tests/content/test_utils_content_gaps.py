"""Test module for test utils content gaps."""
# ruff: noqa: E402
import sys
import types
...
def test_sanitize_text_removes_scripts():
    """Test case for test sanitize text removes scripts."""
...
def test_safe_analyze_fallback_on_failure(monkeypatch, caplog):
    """Test case for test safe analyze fallback on failure."""
...
def test_safe_analyze_handles_empty_and_truncates(monkeypatch):
    ...
    """Test case for test safe analyze handles empty and truncates."""
    class DummyPipeline:
...
def test_antivirus_scan_logs_on_failure(caplog):
    """Test case for test antivirus scan logs on failure."""
    caplog.set_level("ERROR")
