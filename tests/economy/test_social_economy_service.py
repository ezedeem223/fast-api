"""Test module for test session24 social economy."""
import pytest
...
def test_quality_and_engagement_scores(session):
    """Test case for test quality and engagement scores."""
...
def test_update_post_score_adds_credits(session):
    """Test case for test update post score adds credits."""
    user = models.User(
...
def test_bulk_update_post_scores(session):
    """Test case for test bulk update post scores."""
    user = models.User(
...
def test_recommendations_flow_prioritizes_followed(session, monkeypatch):
    """Test case for test recommendations flow prioritizes followed."""
