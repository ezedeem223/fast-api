"""Test module for test local economy support reporting."""
...
def test_local_economy_invalid_and_permissions(session):
    """Test case for test local economy invalid and permissions."""
...
def test_support_happy_and_invalid(session):
    """Test case for test support happy and invalid."""
...
def test_reporting_invalid_and_duplicate(session):
    """Test case for test reporting invalid and duplicate."""
    ...
    assert (
        exc.value.detail
        == "Provide either post_id or comment_id to submit a report"
    )
...
def test_block_appeal_flow(session):
    """Test case for test block appeal flow."""
