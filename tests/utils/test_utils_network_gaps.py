...
def test_parse_json_response_handles_non_json(caplog):
    """Test case for test parse json response handles non json."""
    class BadResp:
        def json(self):
...
def test_safe_request_logs_network_error(caplog):
    """Test case for test safe request logs network error."""
    def bad():
