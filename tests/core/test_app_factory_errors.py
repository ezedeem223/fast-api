"""Test module for test session11 app factory errors."""
...
def test_app_exception_handler_returns_standard_json():
    """Test case for test app exception handler returns standard json."""
    app = _make_app()
...
def test_validation_and_rate_limit_handlers():
    """Test case for test validation and rate limit handlers."""
    app = _make_app()
...
def test_sqlalchemy_and_generic_error_handler(monkeypatch):
    """Test case for test sqlalchemy and generic error handler."""
    app = _make_app()
