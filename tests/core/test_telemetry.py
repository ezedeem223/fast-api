...
def test_setup_tracing_missing_otel(monkeypatch, caplog):
    """Test case for test setup tracing missing otel."""
    caplog.set_level("INFO")
...
def test_setup_tracing_console_and_instrumentors(monkeypatch, caplog):
    """Test case for test setup tracing console and instrumentors."""
    # Arrange: stub telemetry components to capture configuration.
    caplog.set_level("INFO")
    recorded = {}
    ...
    # Act/Assert: setup uses console exporter and instruments dependencies.
...
def test_setup_sentry_no_dsn_noop(caplog):
    """Test case for test setup sentry no dsn noop."""
    caplog.set_level("INFO")
...
def test_setup_sentry_missing_package(monkeypatch, caplog):
    """Test case for test setup sentry missing package."""
...
def test_setup_sentry_initializes(monkeypatch, caplog):
    """Test case for test setup sentry initializes."""
    caplog.set_level("INFO")
    calls = {}
