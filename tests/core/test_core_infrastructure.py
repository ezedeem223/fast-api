"""Test module for test core infrastructure."""
...
def test_livez_readyz_success(client):
    """Test case for test livez readyz success."""
...
async def test_cache_manager_get_set():
    """Test case for test cache manager get set."""
...
async def test_cache_decorator_hits_cache(monkeypatch):
    ...
    """Test case for test cache decorator hits cache."""
    fake = _FakeRedis()
...
def test_search_cache_fallback(monkeypatch, authorized_client, test_post):
    ...
    """Test case for test search cache fallback."""
    class BrokenCache:
        def get(self, *_):
