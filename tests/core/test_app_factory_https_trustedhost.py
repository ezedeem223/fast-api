"""Test module for test app factory https trustedhost."""
...
def test_force_https_enabled_adds_middleware(monkeypatch):
    """Test case for test force https enabled adds middleware."""
...
def test_force_https_disabled_not_added(monkeypatch):
    """Test case for test force https disabled not added."""
...
def test_trusted_host_added(monkeypatch):
    """Test case for test trusted host added."""
    allowed = ["example.com"]
