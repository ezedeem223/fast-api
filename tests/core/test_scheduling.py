"""Test module for test session9 scheduling."""
import pytest
...
async def test_configure_scheduler_and_repeat_tasks_skip_in_test(monkeypatch):
    """Test case for test configure scheduler and repeat tasks skip in test."""
...
async def test_cleanup_old_notifications_and_retry(monkeypatch, session):
    """Test case for test cleanup old notifications and retry."""
...
def test_celery_schedule_post_publication(monkeypatch, session):
    """Test case for test celery schedule post publication."""
...
def test_celery_cleanup_and_process_wrappers(monkeypatch, session):
    """Test case for test celery cleanup and process wrappers."""
