"""Test module for test community."""
...
def test_create_community_returns_owner_details(authorized_client):
    """Test case for test create community returns owner details."""
...
def test_list_communities_includes_created(authorized_client):
    """Test case for test list communities includes created."""
...
def test_join_community_adds_member(authorized_client, client, test_user2):
    """Test case for test join community adds member."""
...
def test_join_community_twice_is_prevented(authorized_client, client, test_user2):
    """Test case for test join community twice is prevented."""
...
def test_create_post_requires_membership(authorized_client, client, test_user2):
    """Test case for test create post requires membership."""
