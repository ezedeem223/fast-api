"""Test module for test community router session26."""
...
def test_create_and_get_community():
    """Test case for test create and get community."""
...
def test_join_requires_existing_invite_for_private():
    """Test case for test join requires existing invite for private."""
    with TestingSessionLocal() as db:
...
def test_router_invite_and_accept_flow():
    """Test case for test router invite and accept flow."""
    with TestingSessionLocal() as db:
...
def test_get_communities_sorted():
    """Test case for test get communities sorted."""
    with TestingSessionLocal() as db:
        user = seed_user(db)
        client = make_client(db)
        for idx in range(3):
