"""Test module for test session3 auth oauth admin."""
import asyncio
...
def test_login_success_invalid_and_lockout_flow(client, session):
    """Test case for test login success invalid and lockout flow."""
...
def test_login_2fa_success_and_failure(client, session):
    """Test case for test login 2fa success and failure."""
...
def test_refresh_and_logout_blacklists_token(client, session):
    ...
    try:
        ...
        settings.refresh_algorithm = original_refresh_alg
...
def test_oauth2_token_creation_and_expiry_handling():
    """Test case for test oauth2 token creation and expiry handling."""
...
def test_admin_and_moderator_authorization(client, session):
    """Test case for test admin and moderator authorization."""
