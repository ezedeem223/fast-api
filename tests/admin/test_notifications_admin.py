"""Test module for test session15 notifications admin."""
...
def test_notifications_list_pagination_and_include_read(session):
    """Test case for test notifications list pagination and include read."""
...
def test_mark_notification_wrong_user_and_not_found(session):
    """Test case for test mark notification wrong user and not found."""
    ...
    assert resp_missing.json()["detail"] == "Notification not found"
