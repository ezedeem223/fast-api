"""Test module for test session23 user service."""
import pytest
...
def test_profile_and_privacy_updates(session):
    """Test case for test profile and privacy updates."""
    user = models.User(
...
def test_followers_visibility_private(session, monkeypatch):
    """Test case for test followers visibility private."""
    owner = models.User(
...
def test_followers_visibility_custom_allows_listed(session, monkeypatch):
    """Test case for test followers visibility custom allows listed."""
    owner = models.User(
...
def test_followers_visibility_custom_blocks_unlisted(session, monkeypatch):
    """Test case for test followers visibility custom blocks unlisted."""
    owner = models.User(
...
def test_language_update_and_public_key(session, monkeypatch):
    """Test case for test language update and public key."""
    user = models.User(
...
def test_upload_profile_image_validates(monkeypatch, session, tmp_path):
    """Test case for test upload profile image validates."""
...
def test_verify_user_document(monkeypatch, session, tmp_path):
    """Test case for test verify user document."""
    user = models.User(
