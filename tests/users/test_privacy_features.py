"""Test module for test privacy features."""
...
def test_export_includes_posts_comments_and_identities(
    ...
    # create a comment
    """Test case for test export includes posts comments and identities."""
...
def test_delete_account_removes_user_and_content(
    ...
    """Test case for test delete account removes user and content."""
