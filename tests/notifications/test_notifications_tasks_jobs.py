"""Test module for test notifications tasks jobs."""
...
def test_cleanup_old_notifications_archives_read(session, test_user):
    """Test case for test cleanup old notifications archives read."""
...
def test_cleanup_old_notifications_deletes_archived(session, test_user):
    """Test case for test cleanup old notifications deletes archived."""
...
def test_cleanup_old_notifications_no_data_noop(session, test_user):
    """Test case for test cleanup old notifications no data noop."""
...
def test_cleanup_old_notifications_commits(monkeypatch, session):
    """Test case for test cleanup old notifications commits."""
    called = {"commit": 0}
...
def test_process_scheduled_notifications_enqueues_and_sets_delivered(
    ...
    """Test case for test process scheduled notifications enqueues and sets delivered."""
...
def test_process_scheduled_notifications_non_due_noop(session, test_user):
    """Test case for test process scheduled notifications non due noop."""
...
def test_process_scheduled_notifications_enqueue_exception_logged(
    ...
    """Test case for test process scheduled notifications enqueue exception logged."""
    due = datetime.now(timezone.utc) - timedelta(minutes=1)
    n = notification_models.Notification(
        user_id=test_user["id"],
        content="due",
...
def test_deliver_notification_task_missing_notification(session):
    """Test case for test deliver notification task missing notification."""
    email = MagicMock()
    push = MagicMock()
...
def test_deliver_notification_task_missing_prefs(session, test_user):
    """Test case for test deliver notification task missing prefs."""
    n = notification_models.Notification(
        user_id=test_user["id"],
        content="msg",
        notification_type="t",
...
def test_deliver_notification_task_email_sender_raises_logged(
    ...
    """Test case for test deliver notification task email sender raises logged."""
    n = notification_models.Notification(
        user_id=test_user["id"],
        content="email",
        notification_type="t",
...
def test_deliver_notification_task_push_sender_raises_logged(
    ...
    """Test case for test deliver notification task push sender raises logged."""
    n = notification_models.Notification(
        user_id=test_user["id"],
        content="push",
        notification_type="t",
