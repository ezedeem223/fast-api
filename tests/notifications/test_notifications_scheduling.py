"""Test module for test notifications scheduling."""
...
def test_deliver_notification_task_handles_channel_failures(session, test_user, caplog):
    """Test case for test deliver notification task handles channel failures."""
...
async def test_send_real_time_notification_logs_on_error(monkeypatch, caplog):
    """Test case for test send real time notification logs on error."""
